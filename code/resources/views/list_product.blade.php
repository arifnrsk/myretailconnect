                    ...
                    <div class="card rounded-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-content d-flex">
                                <p class="card-text card-price border border-dark rounded-3 p-1">Rp {{ number_format($product->price, 2, ',', '.') }}</p>
                                <p class="card-text card-stock ms-3 border border-dark rounded-3 p-1 mb-3">{{ $product->stock }} pcs</p>
                            </div>
                        </div>
                    </div>
                </a>
