            ...
            <div class="container rcm-container mt-4 mb-4">
                ...
                <div class="row mb-3 row-content-invoce d-flex justify-content-center">
                    ...
                    <div class="row d-flex align-items-center" style="padding-top: 15px; border-top: 1px solid #6c757d;">
                        <div class="col-10">
                            <strong>
                                Total Amount: <br> Rp {{ number_format($invoice->transaction->total_amount, 2, ',', '.') }}
                            </strong>
                        </div>
                        <div class="col-2">
                            @if ($canReview)
                                <button class="detail-delivery-btn" id="reviewButton" onclick="openReviewModal({{ $invoice->transaction_id }}, {{ json_encode($invoice->transaction->transactionDetails) }})">
                                    Review Products
                                </button>
                            @endif                             
                        </div>                        
