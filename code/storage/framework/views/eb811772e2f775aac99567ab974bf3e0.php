<?php $__env->startPush('styles_customer_cart'); ?>
<link rel="stylesheet" href="<?php echo e(asset('css/customer_cart.css')); ?>">
<?php $__env->stopPush(); ?>
    ...
    <div class="rmc-flex">
        <div class="row review-main-content">
            ...
            <div class="container rcm-container mt-4">
                <form class="d-flex flex-column align-items-center" action="<?php echo e(route('cart.checkout')); ?>" method="POST" style="width: 100%">
                    <?php echo csrf_field(); ?>
                    <div class="row mb-4 align-items-center" style="width: 95%; height: 100px; background-color: white; border-radius: 10px;">
                        <div class="col-6" style="text-align: center;">
                            ...
                            <strong><?php echo e($customerInfo ? $customerInfo->address : 'No address provided'); ?></strong>
                        </div>
                        <div class="col-6 d-flex flex-column align-items-center" style="text-align: center;">
                            ...
                            <select name="delivery_type" class="form-select mt-2" style="width: 50%; border-radius: 10px;">
                                ...
                                <?php $__currentLoopData = $deliveryTypeInfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->id); ?>" data-price="<?php echo e($item->price); ?>">
                                        <?php echo e($item->name); ?> - Rp <?php echo e(number_format($item->price, 2, ',', '.')); ?>
                    ...
                    <div class="row mb-4 align-items-center" style="width: 95%; height: 120px; background-color: white; border-radius: 10px;">
                        <div class="col-3">
                            <!-- Product image cart -->
                            <img src="<?php echo e(asset('storage/products/'.$item->product->images->first()->image_path)); ?>" alt="<?php echo e($item->product->name); ?>" style="height: 100px; border-radius: 15px;">
                        </div>
                        <div class="col-3">
                            <!-- Product name cart -->
                        ...
                        <div class="col-3">
                            <!-- Product price cart -->
                            Rp <?php echo e(number_format($item->product->price, 2, ',', '.')); ?>

                        </div>
                        <div class="col-1">
                            <!-- Product quantity -->
                            <input type="number" value="<?php echo e($item->quantity); ?>" class="quantity-input" data-cart-item-id="<?php echo e($item->id); ?>" data-product-id="<?php echo e($item->product->id); ?>" data-product-price="<?php echo e($item->product->price); ?>" style="width: 50px; text-align: center; border: 1px solid #212529;border-radius: 10px;">
                        </div>
                        <div class="col-2">
                            
                            <button type="button" onclick="deleteCartItem('<?php echo e($item->id); ?>')" class="delete-cart-btn">Delete</button>
                        </div>
                        <input type="hidden" name="cart_items[<?php echo e($item->id); ?>][product_id]" value="<?php echo e($item->product->id); ?>">
                        <input type="hidden" name="cart_items[<?php echo e($item->id); ?>][quantity]" value="<?php echo e($item->quantity); ?>">
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<script>
        ...
        if(confirm('Are you sure you want to delete this item?')) {
            ...
            .then(data => {
                if(data.success) {
                    ...
                    // Refresh halaman atau update UI untuk menghapus item dari tampilan
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateTotal() {
            ...
            var formattedPrice = 'Rp ' + total.toLocaleString("id-ID", { style: "currency", currency: "IDR" });
        ...
        document.querySelectorAll('.quantity-input').forEach(input => {
            input.addEventListener('change', function() {
                ...
                // Update total setelah perubahan kuantitas
                updateTotal();
            });
        });
        ...
        // Jika menambahkan produk baru ke keranjang, pastikan untuk memanggil updateTotal()
        // di tempat yang sesuai setelah produk berhasil ditambahkan ke DOM
        // Contoh:
        // addProductToCart(productId).then(() => {
            // updateTotal(); // Pastikan ini dipanggil setelah produk ditambahkan ke DOM
        // });
...
<?php echo $__env->make('customer.layouts.customer_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\AcerP\Documents\Kuliah\SMT5\Web Programming\2\adminside\resources\views/customer/customer_cart.blade.php ENDPATH**/ ?>