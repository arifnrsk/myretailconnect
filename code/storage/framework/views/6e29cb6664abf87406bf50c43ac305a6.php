        ...
        <div class="row review-main-content">
            ...
            <div class="container rcm-container mt-4">
                ...
                <div class="row mb-4 align-items-center" style="width: 95%; height: 120px; background-color: white; border-radius: 10px;">
                    ...
                    <div class="col-2">
                        <!-- Assign Courier Name -->
                        <select class="form-select" id="courierSelect" onchange="updateCourier(<?php echo e($delivery->id); ?>, this.value)">
                    ...
                    <div class="col-2">
                        <!-- Assign Status -->
                        <select class="form-select" id="statusSelect" onchange="updateStatus(<?php echo e($delivery->id); ?>, this.value)">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\AcerP\Documents\Kuliah\SMT5\Web Programming\2\fix adminside\adminside\resources\views/delivery.blade.php ENDPATH**/ ?>