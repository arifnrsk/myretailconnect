        ...
        <div class="row review-main-content">
            ...
            <div class="container rcm-container mt-4">
                ...
                <div class="row mb-4 align-items-center" style="width: 95%; height: 120px; background-color: white; border-radius: 10px;">
                    ...
                    <div class="col-2">
                        <!-- Transaction date -->
                        <?php echo e($transaction->transaction_date->format('M d, Y')); ?> at <?php echo e($transaction->transaction_date->format('h:i A')); ?>

                    </div>
                    <div class="col-2">
                        <!-- Transaction status -->
                        <?php echo e($transaction->transactionStatus->name); ?>

                    </div>
                    <div class="col-2">
                        <!-- Total Amount -->
                        Rp <?php echo e(number_format($transaction->total_amount, 2, ',', '.')); ?>

                    </div>
                    <div class="col-2">
                        <div class="col-3 d-flex flex-column align-items-center w-100">
                            <a href="<?php echo e(route('invoices.show', ['id' => $transaction->invoice->id])); ?>" style="width: 70%;">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\AcerP\Documents\Kuliah\SMT5\Web Programming\2\fix adminside\adminside\resources\views/transaction_history.blade.php ENDPATH**/ ?>