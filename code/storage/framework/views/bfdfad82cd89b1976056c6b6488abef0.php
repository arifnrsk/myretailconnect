        ...
        <div class="row">
            ...
            <div class="col-3 p-0" id="side-navbar">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(url('/return-and-refund')); ?>"><img src="<?php echo e(asset('icons/Icon remove shopping cart.svg')); ?>" alt="Returns & Refunds Icon"><span class="nav-text">Returns & Refunds</span></a>
                    </li>
                    <li class="nav-item">
...
</html><?php /**PATH C:\Users\AcerP\Documents\Kuliah\SMT5\Web Programming\2\adminside\resources\views/layouts/master.blade.php ENDPATH**/ ?>