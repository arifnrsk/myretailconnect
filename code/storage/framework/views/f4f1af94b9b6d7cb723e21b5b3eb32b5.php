                ...
                <div class="row mb-3 d-flex justify-content-center align-items-center w-100" style="margin-top: 15px; border-top: 1px solid #6c757d;">    
                    <div class="col-6 add-buttons">
                        <div class="col-12 add-buttons-content d-flex flex-column align-items-center justify-content-center">
                            ...
                            <button type="button" class="cancel-product-btn mb-3" onclick="window.location.href='<?php echo e(url('/list-product')); ?>'">
                                Cancel
                            </button>                            
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\AcerP\Documents\Kuliah\SMT5\Web Programming\2\fix adminside\adminside\resources\views/add_product.blade.php ENDPATH**/ ?>